...
import { FaHome, FaCube, FaColumns, FaMicrophone, FaShapes, FaCalculator, FaRuler, FaKey, FaMouse, FaList, FaDice, FaShoppingCart, FaWpforms } from "react-icons/fa";
...
const mainItems: SidebarItem[] = [
  ...
  { label: "Número Aleatorio", route: "/random", icon: <FaDice /> },    //* --- agregado
  { label: "Formulario de Registro", route: "/registerform", icon: <FaWpforms /> },
];
...
const exerciseItems: SidebarItem[] = [
  ...
  { label: "Encuesta", route: "/survey", icon: <FaList /> },              //* --- agregado
